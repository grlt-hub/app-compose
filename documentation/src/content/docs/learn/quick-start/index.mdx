---
title: Quick Start
description: Walk through App-Compose in five steps — create a Task, run it, pass data, disable it, handle failures.
---
...
<Sandbox anchor="run-task" template="vanilla-ts" code={runTask} options={{ layout: "console", showConsoleButton: false }} />
...
<Sandbox anchor="disable" template="vanilla-ts" code={disable} options={{ layout: "console", showConsoleButton: false }} />
